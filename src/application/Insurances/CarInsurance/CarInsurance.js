    ...
    render() {
        ...
        return (
            <Container component="main" maxWidth="sm">
                ...
                <Form className={this.useStyles.form}>
                    <div className={this.useStyles.formTitle}>

                        <h1>Segurado</h1>
                    </div>

                    <TextField className={this.useStyles.input} id="standard-basic" label="Nome completo" fullWidth variant="outlined" />

                    <TextField className={this.useStyles.input} id="cpf" label="CPF/CNPJ" fullWidth variant="outlined" />

                    <TextField className={this.useStyles.input} id="cu-basic" label="Data de Nascimento" fullWidth variant="outlined" />
                    ...
                    <hr />
                    <div className={this.useStyles.btnContainer} >

                        <MaterialButton className={this.useStyles.button} color={"secondary"} variant="contained">Voltar</MaterialButton>
                        <MaterialButton className={this.useStyles.button} color={"primary"} variant="contained">Próximo</MaterialButton>
                    </div>
                    <br></br>
                    <br></br>
                    <br></br>
                    ...
                    <div className={this.useStyles.btnContainer}>
                        ...
                        <MaterialButton className={this.useStyles.button} variant="outlined">Voltar</MaterialButton>
                        <MaterialButton className={this.useStyles.button} color={"primary"} variant="contained">Próximo</MaterialButton>
                    </div>
                    ...
                    <FormControl className={this.useStyles.formControl} fullWidth>
